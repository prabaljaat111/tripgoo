  ...
  return <>
      ...
      <AnimatePresence>
        ...
        opacity: 0
          ...
          stiffness: 300,
          damping: 30
        }} className="absolute bottom-24 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-sm liquid-glass rounded-3xl p-5 overflow-hidden" onClick={e => e.stopPropagation()}>
