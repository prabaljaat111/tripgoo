        ...
        {showServices && (
          ...
          >
            <motion.div
              ...
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-2rem)] max-w-lg liquid-glass rounded-3xl p-4 sm:p-5 overflow-hidden max-h-[80vh] overflow-y-auto"
              ...
              <div className="grid grid-cols-4 gap-3">
                {travelServices.map((service) => (
                  <Link
                    ...
                    to={service.path}
                    onClick={() => setShowServices(false)}
                    className="flex flex-col items-center gap-1.5 p-2 rounded-2xl hover:bg-white/40 active:scale-95 transition-all"
                  >
            ...
            >
              ...
              <div className="space-y-1">
                <Link
                  to="/dashboard"
                  onClick={() => setShowProfile(false)}
                  className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/40 active:scale-[0.98] transition-all"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-red-50 active:scale-[0.98] transition-all text-left"
                >
