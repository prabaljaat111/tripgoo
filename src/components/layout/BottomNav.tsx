  ...
  return <>
      ...
      <AnimatePresence>
        ...
        opacity: 0
          ...
          stiffness: 300,
          damping: 30
        }} onClick={e => e.stopPropagation()} className="fixed bottom-20 sm:bottom-24 left-1/2 -translate-x-1/2 w-[calc(100%-1.5rem)] sm:w-[400px] liquid-glass rounded-3xl p-4 sm:p-5 max-h-[60vh] overflow-y-auto">
